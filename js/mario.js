    ...
    pagePokemons.forEach((pokemon) => {
      ...
      viewCards.innerHTML += `
        <div class="border border-gray-400 bg-gradient-to-b from-gray-500 to-gray-900 h-80 w-60 gap-3 rounded-lg flex flex-col items-center justify-center p-3 shadow-lg">
          ...
          <button class="openBtn mt-2 hover:cursor-pointer hover:bg-red-500 hover:scale-105 transition duration-150 text-white h-8 w-40 bg-red-800 hover:border-red-400 border border-red-500 text-sm font-bold rounded-full flex items-center justify-center gap-2">
            POKEDEX
